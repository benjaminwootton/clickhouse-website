...
In a [recent blog post](/blog/clickhouse-vehicle-route-planning) we looked into a data science problem involving optimising how to route delivery vehicles around the country in the most efficient way.
