...
date_published: 2023-11-13T14:06:16.000Z
date_updated: 2023-11-13T14:39:30.000Z
order: 12
image: /x.jpg
featured_image: 45.jpg
background_color:
    - "#DF6B9C"
    - "#E74C68"
tag: General
...
In [our article comparing ClickHouse and Snowflake pricing](https://ensembleai.io/blog/comparing-clickhouse-snowflake-pricing) we identifed that ClickHouse Cloud is less than half the cost of Snowflake in terms of buying the equivalent compute capacity.  And when you consider the fact that ClickHouse performs much better and more scalably, the same workloads can be served with even less infrastructure.  This means that we are paying less for less compute capacity to meet an equivalent set of user requirements.  
