...
In [recent blog posts](/blog) we demonstrated how data science techniques such as [forecasting](/blog/forecasting-using-clickhouse) and [anomaly detection](/blog/anomaly-detection-using-clickhouse) can be implemented entirely within ClickHouse using only SQL.  
